...
var j;
var LISTS = {
	rhetoric:   { label: 'Rhetoric',   color: 'cyan' },
	opinion:    { label: 'Opinion',    color: 'lightpink' },
	sentiment:  { label: 'Sentiment',  color: 'lightgreen' },
	commentary: { label: 'Commentary', color: 'lightblue' },
};
